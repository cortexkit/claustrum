...
# The current measured total is MEASURED_FLOOR_PLACEHOLDER (debug profile, the same command this arm
...
run_expect MEASURED_FLOOR_PLACEHOLDER "workspace unit + integration" \
